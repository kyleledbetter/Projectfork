...
<div id="projectfork" class="category-list<?php echo $this->pageclass_sfx;?> view-repository">
    ...
    <div class="row-fluid">
    	<div class="span9">
    		<a href="#album1" data-toggle="collapse"><h3><span aria-hidden="true" class="icon-menu-2"></span> Album One</h3></a>
    		<div id="album1" class="collapse in">
	    		<div class="row-fluid row-album">
	    			<div class="span6">
	    				<a href="#" class="thumbnail">
	    					<img class="" src="http://placehold.it/400x298/471437/FFF/&amp;text=Design" alt="">
	    				</a>
	    			</div>
	    			<div class="span4">
	    				<a href="#" class="thumbnail">
	    					<img class="" src="http://placehold.it/400x212/B13254/FFF/&amp;text=Design" alt="">
	    				</a>
	    				<a href="#" class="thumbnail">
	    					<img class="" src="http://placehold.it/400x212/FF5449/FFF/&amp;text=Design" alt="">
	    				</a>
	    			</div>
	    			<div class="span2">
	    				<a href="#" class="thumbnail">
	    					<img class="" src="http://placehold.it/400x288/FF7349/FFF/&amp;text=Design" alt="">
	    				</a>
	    				<a href="#" class="thumbnail">
	    					<img class="" src="http://placehold.it/400x288/FF9249/FFF/&amp;text=Design" alt="">
	    				</a>
	    				<a href="#" class="thumbnail">
	    					<img class="" src="http://placehold.it/400x288/FFB44A/FFF/&amp;text=Design" alt="">
	    				</a>
	    			</div>
	    		</div>
    		</div>
    		<a href="#album2" data-toggle="collapse"><h3><span aria-hidden="true" class="icon-menu-2"></span> Album Two</h3></a>
    		<div id="album2" class="collapse in">
    			<div class="row-fluid row-album">
    				<div class="span6">
    					<a href="#" class="thumbnail">
    						<img class="" src="http://placehold.it/400x298/262436/FFF/&amp;text=Design" alt="">
    					</a>
    				</div>
    				<div class="span4">
    					<a href="#" class="thumbnail">
    						<img class="" src="http://placehold.it/400x212/503C53/FFF/&amp;text=Design" alt="">
    					</a>
    					<a href="#" class="thumbnail">
    						<img class="" src="http://placehold.it/400x212/9F6C66/FFF/&amp;text=Design" alt="">
    					</a>
    				</div>
    				<div class="span2">
    					<a href="#" class="thumbnail">
    						<img class="" src="http://placehold.it/400x288/D4896A/FFF/&amp;text=Design" alt="">
    					</a>
    					<a href="#" class="thumbnail">
    						<img class="" src="http://placehold.it/400x288/FFBB6C/FFF/&amp;text=Design" alt="">
    					</a>
    					<a href="#" class="thumbnail">
    						<img class="" src="http://placehold.it/400x288/FFE066/FFF/&amp;text=Design" alt="">
    					</a>
    				</div>
    			</div>
    		</div>
    		<a href="#album3" data-toggle="collapse"><h3><span aria-hidden="true" class="icon-menu-2"></span> Album Three</h3></a>
    		<div id="album3" class="collapse in">
    			<div class="row-fluid row-album">
    				<div class="span6">
    					<a href="#" class="thumbnail">
    						<img class="" src="http://placehold.it/400x298/212E32/FFF/&amp;text=Design" alt="">
    					</a>
    				</div>
    				<div class="span4">
    					<a href="#" class="thumbnail">
    						<img class="" src="http://placehold.it/400x212/85937A/FFF/&amp;text=Design" alt="">
    					</a>
    					<a href="#" class="thumbnail">
    						<img class="" src="http://placehold.it/400x212/586C5D/FFF/&amp;text=Design" alt="">
    					</a>
    				</div>
    				<div class="span2">
    					<a href="#" class="thumbnail">
    						<img class="" src="http://placehold.it/400x288/A9AF90/FFF/&amp;text=Design" alt="">
    					</a>
    					<a href="#" class="thumbnail">
    						<img class="" src="http://placehold.it/400x288/DEDCB8/FFF/&amp;text=Design" alt="">
    					</a>
    					<a href="#" class="thumbnail">
    						<img class="" src="http://placehold.it/400x288/DEDACD/FFF/&amp;text=Design" alt="">
    					</a>
    				</div>
    			</div>
    		</div>
    			...
    			<div class="control-group">
    				<div class="controls">
    					...
    					<div class="progress progress-striped"><a class="close" data-dismiss="alert" href="#">&times;</a>
    						<div class="bar" style="width: 65%;">design2.png</div>
    					</div>
    					<div class="progress progress-striped"><a class="close" data-dismiss="alert" href="#">&times;</a>
    						<div class="bar" style="width: 45%;">design3.png</div>
    					</div>
    					<div class="center">
    						<a href="#" class="btn btn-primary btn-wide"><span aria-hidden="true" class="icon-pictures"></span> Create Album</a>
    					</div>
    				</div>
    			</div>
    		</form>
